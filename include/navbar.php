            ...
            <div class="nav-item dropdown u-pro">
                <a class="nav-link dropdown-content waves-effect waves-dark profile-pic" href="#" id="navbarDropdown"
                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
                        src="../assets/images/pasien.png" alt="user" class="" /> <span
                        class="hidden-md-down"><?php echo $_SESSION['username']; ?> &nbsp;</span> </a>
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <!-- <a class="dropdown-item" href="../main/user/profile.php"><i class="fa fa-user"></i> Profile</a>
                    <a class="dropdown-item" href="../main/user/setting.php"><i class="fa fa-cog"></i> Setting</a> -->
